    ...
    return (
      <div>
        <div className="project-heading">
          <h3>docs-soap</h3>
          <h6>Technologies:</h6><span>Node.js, NPM, Babel, Flow, ESLint, Gulp, Codecov, Mocha, TravisCI | <a href="https://github.com/aem/docs-soap">GitHub</a> | <a href="https://npmmjs.com/package/docs-soap">NPM</a> | <img className="badge" src="https://img.shields.io/codecov/c/github/aem/docs-soap.svg" /></span>
        </div>
        <p>
