...
const tiles = new Map({
  ...
  developer: "I've got roughly 8 years of development experience (I taught myself C at the age of 13!) and my experience has led me to be a web developer with full-stack skills, but specializing in front-end development.",
  video: "As a part-time job, I work for Northeastern University's athletics department. All of the school's home athletic events are streamed online in HD, and occasionally appearing on cable or network television. I work primarily as a Producer, Director, Technical Director, and, as needed, instant replay operator and graphics producer.",
  fraternity: "Pictured at our founding location (Washington Square Arch, NYC), I am a brother of Alpha Epsilon Pi, having served as our publicity chair for a year, and coordinating our annual philanthropy boat cruise which raises more than $25,000 for charity. I am currently serving as the Interfraternity Council president on campus, with focuses on educating about and reducing hazing and sexual assault on campus.",
  biking: "About two years ago I took up biking, initially as a way to commute to work, and eventually I continued to bike in my free time. Since then I've biked more than 1,000 miles across the city of Boston and its outlying suburbs. Beginning next year I plan to enter races in the Boston area with a stretch goal of being ready to partake in the Pan-Mass Challenge next summer."
});
